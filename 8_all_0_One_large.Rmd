...
# Example with 50 counts (Extreme Case: all 0 and only one large count)
...
e2a1 <- ggplot(data = results1, aes(values, fill = ind)) + 
  geom_histogram() + 
  facet_wrap(~ind, scales = "free") + 
  geom_vline(data = truevalue, aes(xintercept = true)) + 
  ggtitle("Example 2 - Algorithm 1")

e2a1

ggsave("e2a1.png", e2a1)
```
...
e2a2 <- ggplot(data = results2, aes(values, fill = ind)) + 
  geom_histogram() + 
  facet_wrap(~ind, scales = "free") + 
  geom_vline(data = truevalue, aes(xintercept = true)) + 
...
e2a3 <- ggplot(data = results3, aes(values, fill = ind)) + 
  geom_histogram() + 
  facet_wrap(~ind, scales = "free") + 
  geom_vline(data = truevalue, aes(xintercept = true)) + 
  ggtitle("Example 2 - Algorithm 3")

e2a3

ggsave("e2a3.png", e2a3)
```
